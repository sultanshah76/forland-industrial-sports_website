      ...
      <section className="relative  overflow-hidden bg-primary py-5 dark:bg-dark lg:py-[80px] ">
        <div className="container border-x-8 border-y-8 border-white text-white">
          ...
          <ul>
            ...
            <li>
              Production will begin only after receiving your approval of the
              sample.
            </li>
            <li>
              Please note that a non-refundable advance payment will be required
              for all samples before the sample is provided.
            </li>
          </ul>
          <p>&nbsp;</p>
          ...
          <ul>
            ...
            <li>
              The remaining 50% balance must be paid upon completion of the
              order but before shipment.
            </li>
            <li>
              For established customers with a proven payment history,
              alternative payment terms may be negotiated on a case-by-case
              basis.
            </li>
          </ul>
          <p>&nbsp;</p>
          ...
          <ul>
            ...
            <li>
              Timely payment is essential to ensure your orders smooth
          ...
          <ul>
            <li>
              ...
              three days of placing the order.
            </li>
            <li>
              Cancellation requests received after the production process has
              started may be subject to additional charges.
            </li>
          </ul>
          <p>&nbsp;</p>
          ...
          <ul>
            ...
            <li>
              We are committed to arranging secure and reliable delivery
              services for your order. Our goal is to ensure your productssafe
              and timely delivery to the specified destination. If you have any
              specific shipping preferences or requirements, please communicate
              them to us, and we will do our best to accommodate your needs.
            </li>
          </ul>
          <p>&nbsp;</p>
          ...
          <p>
            ...
            customs duties, or other charges imposed by their local authorities
            or customs agencies related to purchasing and importing our
            products. Please consult with your local tax authorities or customs
          ...
          <p>
            ...
            Payment is required before production begins and before shipment. We
            do not provide products on credit or extend credit terms to
            customers.
          </p>
          <p>&nbsp;</p>
          ...
          <ul>
            ...
            <li>
              Refunds will be issued for the returned items, or replacements
              will be provided, per our Return Policy.
            </li>
          </ul>
          <p>&nbsp;</p>
        ...
        <br />
            <strong >
              Please do not hesitate to email us at if you have any questions or
              require further clarification regarding our payment terms.
            </strong>
          </p>
          </div>
      </section>
